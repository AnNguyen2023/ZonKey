/**
 * M3D-28 orchestration: spawns the zonkey-cli validation endpoint (with the
 * recovery registry) and runs the real-VS-Code recovery E2E, then stops the
...
const pipeName = `\\\\.\\pipe\\zonkey-m3d28-${Date.now()}`;
const workspaceDir = mkdtempSync(join(tmpdir(), "zonkey-m3d28-"));
